...
export default class UpdateProfile extends React.Component {
	...
	// 	this.changeProfileState("domains_of_interest", domains.
	// length > 0 ? domains.join(" | ") : null);
	// }
		...
		return (
			<div>
				...
				<FormLine
					...
					onChange={(v) => this.changeProfileState("entity_name", v)}
					autofocus={true}
				...
				<FormLine
					...
					onChange={(v) => this.changeProfileState("vat_number", v)}
					autofocus={true}
					onKeyDown={this.onKeyDown}
					disabled={true}
				/>
				<FormLine
					...
					onChange={(v) => this.changeProfileState("company_email", v)}
					autofocus={true}
					onKeyDown={this.onKeyDown}
					disabled={true}
				/>
				<FormLine
					...
					onChange={(v) => this.changeProfileState("company_phone", v)}
					autofocus={true}
					onKeyDown={this.onKeyDown}
					disabled={true}
				/>
				<FormLine
					...
					onChange={(v) => this.changeProfileState("website", v)}
					autofocus={true}
					onKeyDown={this.onKeyDown}
					disabled={true}
				/>
				...
				<FormLine
					...
					onChange={(v) => this.changeProfileState("address", v)}
					onKeyDown={this.onKeyDown}
				...
				<FormLine
					...
					onChange={(v) => this.changeProfileState("city", v)}
					onKeyDown={this.onKeyDown}
					format={validateNotNull}
					disabled={true}
				/>
				<FormLine
					...
					onChange={(v) => this.changeProfileState("postal_code", v)}
					onKeyDown={this.onKeyDown}
					format={validateNotNull}
					disabled={true}
				/>
				<FormLine
					...
					onChange={(v) => this.changeProfileState("po_box", v)}
					onKeyDown={this.onKeyDown}
					disabled={true}
				...
				<FormLine
					...
					onChange={(v) => this.changeProfileState("headquarter_address", v)}
					onKeyDown={this.onKeyDown}
					disabled={true}
					type="textarea"
				/>
				<FormLine
					...
					onChange={(v) => this.changeProfileState("headquarter_city", v)}
					onKeyDown={this.onKeyDown}
					disabled={true}
				/>
				<FormLine
					...
					onChange={(v) => this.changeProfileState("headquarter_postal_code", v)}
					onKeyDown={this.onKeyDown}
					disabled={true}
				/>
				<FormLine
					...
					onChange={(v) => this.changeProfileState("headquarter_po_box", v)}
					onKeyDown={this.onKeyDown}
					disabled={true}
				/>
					...
					? this.state.types
						.map((c) => (
							<FormLine
								...
								onChange={(v) => this.state.selected_types.includes(c.name)}
								disabled={true}	
							/>
						))
					: <Loading
				...
				<FormLine
					...
					onChange={(v) => this.changeProfileState("other", v)}
					autofocus={true}
					onKeyDown={this.onKeyDown}
					disabled={true}
					type="textarea"
				...
				<FormLine
					...
					onChange={(v) => this.changeProfileState("eu_country", v)}
					autofocus={true}
					onKeyDown={this.onKeyDown}
					disabled={true}
					type="textarea"
				...
				<FormLine
					...
					onChange={(v) => this.changeProfileState("shares_country", v)}
					autofocus={true}
					onKeyDown={this.onKeyDown}
					disabled={true}
					type="textarea"
				...
				<FormLine
					...
					onChange={(v) => this.changeProfileState("first_name", v)}
					autofocus={true}
					onKeyDown={this.onKeyDown}
					disabled={true}
				/>
				<FormLine
					...
					onChange={(v) => this.changeProfileState("last_name", v)}
					onKeyDown={this.onKeyDown}
					disabled={true}
				/>
				<FormLine
					...
					onChange={(v) => this.changeProfileState("position_organization", v)}
					onKeyDown={this.onKeyDown}
					format={validateNotNull}
					disabled={true}
				/>
				<FormLine
					...
					onChange={(v) => this.changeProfileState("article_compy_regulation", v)}
					onKeyDown={this.onKeyDown}
					format={validateNotNull}
					disabled={true}
				/>
				<FormLine
					...
					onChange={(v) => this.changeProfileState("telephone", v)}
					onKeyDown={this.onKeyDown}
				...
				<FormLine
					...
					onChange={(v) => this.changeProfileState("person_expertise", v)}
					autofocus={true}
					onKeyDown={this.onKeyDown}
					disabled={true}
					type="textarea"
				...
				<FormLine
					...
					onChange={(v) => this.changeProfileState("field_article_expertise", v)}
					autofocus={true}
					onKeyDown={this.onKeyDown}
					disabled={true}
					type="textarea"
				...
				<FormLine
					...
					onChange={(v) => this.changeProfileState("detail_expertise", v)}
					autofocus={true}
					onKeyDown={this.onKeyDown}
					disabled={true}
					type="textarea"
				...
				<FormLine
					...
					onChange={(v) => this.changeProfileState("taxonomy_other", v)}
					autofocus={true}
					onKeyDown={this.onKeyDown}
					disabled={true}
					type="textarea"
				...
				<FormLine
					...
					onChange={(v) => this.changeProfileState("achieve_join_community", v)}
					autofocus={true}
					onKeyDown={this.onKeyDown}
					disabled={true}
					type="textarea"
				...
				<FormLine
					...
					onChange={(v) => this.changeProfileState("contribution_community", v)}
					autofocus={true}
					onKeyDown={this.onKeyDown}
					disabled={true}
					type="textarea"
				...
				{/* <FormLine
					...
					onChange={(v) => this.changeProfileState("mobile", v)}
					onKeyDown={this.onKeyDown}
					format={validateTelephoneNumber}
				/> */}
				{/* <FormLine
