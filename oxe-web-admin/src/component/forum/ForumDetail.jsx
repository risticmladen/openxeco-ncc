                              ...
                              <div className="thread-content">
                                    ...
                                    <div className="post-details">
                                        {/* <p className="post-updated-at">
																				Latest activity: {timeAgo(new Date(thread.last_activity).toLocaleString())}
																				{repliesCount[thread.id] !== undefined ? `${repliesCount[thread.id]} comments` : "no comments"}
                                             </p> */}
                                        ...
                                        <p className="thread-meta">{repliesCount[thread.id] !== undefined ? `${repliesCount[thread.id]} comments` : "no comments"}</p>
																				 ...
																				 {/* Fixed container for comments and latest activity */}
